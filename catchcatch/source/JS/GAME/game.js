    ...
    if (frameTime > 16.5) {
        ...
        if (bossActive) {
            for (let i = 0; i < bossSet.children.entries.length; i++) {
                ...
                if (bossSet.children.entries[i].bossSpecie === "golem") {
                    if (bossGolemActive && (gameTimer % 240 === 0)) {
                        addMonster(this, "wormPlus", "wormPlus", 100, 50, bossSet.children.entries[i].x, bossSet.children.entries[i].y + 150);
                    }
                }
